    ...
    <div class="container">
			...
			<div class="row">
		        ...
		        <?php 
					   ...
					   $sql = 'SELECT * FROM assistors ORDER BY aName DESC';
	 				   foreach ($pdo->query($sql) as $row) {
						   		echo '<tr>';
							   	echo '<td>'. $row['aName'] . '</td>';
							   	echo '<td>'. $row['aAddress'] . '</td>';
							   	echo '<td>'. $row['aMunicipality'] . '</td>';
                  echo '<td>'. $row['aState'] . '</td>';
							   	echo '<td>'. $row['aZip'] . '</td>';	
								  echo '<td width=100%>';		   								 							
							   	echo '<a class="btn" href="read1.php?_ID='.$row['_ID'].'">Read</a>';
							   	echo '&nbsp;';
							   	echo '<a class="btn btn-primary" href="update1.php?aName='.$row['aName'].'">Update</a>';
							   	echo '&nbsp;';
							   	echo '<a class="btn btn-danger" href="delete1.php?aName='.$row['aName'].'">Delete</a>';
                  echo '&nbsp;';
                  echo '<a class="btn btn-info" href="display_voters_for_id.php?_ID='.$row['_ID'].'">View Voters</a>';
                  echo '</td>';
							   	echo '</tr>';
					   }
					   Database::disconnect();
