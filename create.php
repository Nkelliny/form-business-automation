<?php 
	...
	if ( !empty($_POST)) {
		...
		if (empty($vanid)) {
 		...
 		else if(strlen($vanid) > 11){
 			$vanidError = 'Please enter a VAN ID less than 11 digits long';
			$valid = false;
 		}
		...
		if ($valid) {
			...
			$sql = "INSERT INTO voters (VANID,Address,City,State,Zip5,Zip4,Lastname,Firstname,Middlename,Suffix,CD,SD,HD,DOB) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
			$q = $pdo->prepare($sql);
			$q->execute(array($vanid,$address,$city,$state,$zip5,$zip4,$lname,$fname,$mname,$suffix,$cd,$sd,$hd,$dob));
			Database::disconnect();
		...
		<div class="span10 offset1">
	    	...
	    	<form class="form-horizontal" action="create.php" method="post">
				<div class="control-group <?php echo !empty($vanidError)?'error':'';?>">
					...
					<div class="controls">
					    <input name="vanid" type="text"  placeholder="VANID" value="<?php echo !empty($vanid)?$vanid:'';?>">
				...
				<div class="control-group <?php echo !empty($zip5Error)?'error':'';?>">
					...
					<div class="controls">
					    <input name="zip5" type="text" placeholder="Zip 5" value="<?php echo !empty($zip5)?$zip5:'';?>">
				...
				<div class="control-group <?php echo !empty($zip4Error)?'error':'';?>">
					...
					<div class="controls">
					    <input name="zip4" type="text"  placeholder="Zip 4" value="<?php echo !empty($zip4)?$zip4:'';?>">
			  ...
			  <div class="control-group <?php echo !empty($fnameError)?'error':'';?>">
				...
				<div class="control-group <?php echo !empty($mnameError)?'error':'';?>">
					...
					<div class="controls">
					    <input name="mname" type="text"  placeholder="Middle Name" value="<?php echo !empty($mname)?$mname:'';?>">
				...
				<div class="control-group <?php echo !empty($suffixError)?'error':'';?>">
					...
					<div class="controls">
					    <input name="suffix" type="text"  placeholder="Suffix" value="<?php echo !empty($suffix)?$suffix:'';?>">
				...
				<div class="control-group <?php echo !empty($cdError)?'error':'';?>">
					...
					<div class="controls">
					    <input name="cd" type="text" placeholder="CD" value="<?php echo !empty($cd)?$cd:'';?>">
					      	<?php if (!empty($cdError)): ?>
				...
				<div class="control-group <?php echo !empty($sdError)?'error':'';?>">
					...
					<div class="controls">
					    <input name="sd" type="text"  placeholder="SD" value="<?php echo !empty($sd)?$sd:'';?>">
				...
				<div class="control-group <?php echo !empty($hdError)?'error':'';?>">
					<label class="control-label">HD</label>
					 <div class="controls">
					    <input name="hd" type="text"  placeholder="HD" value="<?php echo !empty($hd)?$hd:'';?>">
