  ...
  <div class="container-fluid" style="background-color: #2780e3;">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="http://sitelegion.com/devtest/web/software/crud/printAll.html" class="btn btn-primary"><img src="https://cdn2.iconfinder.com/data/icons/pittogrammi/142/07-24.png"> Print All</a></li>
      </ul>
      <script>
			...
			<div class="row">
				<p>
					<a href="create.php" class="btn btn-primary">Create</a>
                                ...
                                <p>
					<a href="import.php" class="btn btn-primary"><img src="https://cdn3.iconfinder.com/data/icons/brands-applications/512/Excel_D-24.png"> Import CSV</a>
				</p>-->
					   ...
					   $sql = 'SELECT * FROM voters ORDER BY VANID DESC';
	 				   foreach ($pdo->query($sql) as $row) {
								...
								echo '<td width=100%>';		   								 							
							   	...
							   	echo '&nbsp;';
							   	echo '<a class="btn btn-primary" href="update.php?VANID='.$row['VANID'].'">Update</a>';
							   	echo '&nbsp;';
