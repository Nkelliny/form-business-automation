<?php 
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$sql = "INSERT INTO assistors (aName,aAddress,aMunicipality,aState,aZip) values(?, ?, ?, ?, ?)";
			$q = $pdo->prepare($sql);
			$q->execute(array($name,$address,$city,$state,$zip));
			Database::disconnect();
  ...
  <div class="container-fluid" style="background-color: #2780e3;">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="create1.php" class="btn btn-primary"><img src="https://cdn2.iconfinder.com/data/icons/windows-8-metro-style/26/add_user.png"> Add Assistor</a></li>
        <li><a href="index.php" class="btn btn-primary"><img src="https://cdn0.iconfinder.com/data/icons/users-android-l-lollipop-icon-pack/24/group2-24.png"> Voters</a></li>
        <li><a href="import1.php" class="btn btn-primary"><img src="https://cdn3.iconfinder.com/data/icons/brands-applications/512/Excel_D-24.png"> Import CSV</a></li>
    	...
    	<div class="span10 offset1">
	    	...
	    	<form class="form-horizontal" action="create1.php" method="post">
				<div class="control-group <?php echo !empty($nameError)?'error':'';?>">
					...
					<div class="controls">
					    <input name="name" type="text"  placeholder="Name" required value="<?php echo !empty($name)?$name:'';?>">
				...
				<div class="control-group <?php echo !empty($addressError)?'error':'';?>">
					...
					<div class="controls">
					    <input name="address" type="text" placeholder="Address" required value="<?php echo !empty($address)?$address:'';?>">
				...
				<div class="control-group <?php echo !empty($cityError)?'error':'';?>">
					...
					<div class="controls">
					    <input name="city" type="text"  placeholder="City" required value="<?php echo !empty($city)?$city:'';?>">
				...
				<div class="control-group <?php echo !empty($stateError)?'error':'';?>">
					...
					<div class="controls">
					    <input name="state" type="text"  placeholder="State" required value="<?php echo !empty($state)?$state:'';?>">
				...
				<div class="control-group <?php echo !empty($zipError)?'error':'';?>">
					...
					<div class="controls">
					    <input name="zip" type="text" placeholder="Zip" required value="<?php echo !empty($zip)?$zip:'';?>">
				...
				<div class="form-actions">
					...
					<a class="btn" href="assist.php">Back</a>
				</div>
			</form>
		</div>				
    </div> <!-- /container -->
